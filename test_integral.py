...
class TestCoreDocstrings:
    ...
    def test_function_docstring_args(self, temp_dir, enforcer):
        """Тест docstring функции с типами в Args."""
        code = '''
...
'''
    ...
    def test_function_docstring_returns(self, temp_dir, enforcer):
        """Тест docstring функции с типами в Returns."""
        code = '''
def calculate() -> None:
    """
    Calculate something.
...
'''
        ...
        assert any(v.standard_type == "bool" for v in violations)

    def test_class_docstring_attributes(self, temp_dir, enforcer):
        """Тест docstring класса с типами в Attributes."""
        code = '''
class DataHolder:
    """
    Hold data.
